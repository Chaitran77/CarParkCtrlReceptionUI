...
public class MergeSort {
    ...
    public static void mergeSort(Log[] logsToSort, String by, String direction) {
        ...
        mergeSort(leftArray, by, direction);
        mergeSort(rightArray, by, direction);
        System.out.println(Arrays.toString(merge(logsToSort, leftArray, rightArray, by, direction)));

    }

    private static Log[] merge(Log[] logsToMerge, Log[] leftArray, Log[] rightArray, String by, String direction) {
                ...
                switch (by) {
                    case "entry_timestamp":
                        ...
                        if (direction.equals("descending")) {
                            ...
                            if (entryDate1.after(entryDate2)) {
                                logsToMerge[k++] = leftArray[i++];
                            } else {
                                logsToMerge[k++] = rightArray[j++];
                            }
